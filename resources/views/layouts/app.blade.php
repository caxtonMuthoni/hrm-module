...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm nav-home">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                <div class="nav-bar__logo nav__logo-2 js--logo-2">
                    <img src="{{asset('/imgs/svgs/HRMBlue.svg')}}" alt="logo" class="nav__logo-2-image">
                </div>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupported">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <ul class="navbar-nav ml-auto nav-drop">
